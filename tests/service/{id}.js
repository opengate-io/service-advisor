...
Test('/service/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getServiceById get operation', function (t) {
            Mockgen().requests({
                path: '/service/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/service/{id}']['get']['responses']['200']['schema']);
         ...
         * responses: 200, default
         */
        t.test('test updateService put operation', function (t) {
            Mockgen().requests({
                path: '/service/{id}',
                operation: 'put'
            }, function (err, mock) {
         ...
         * responses: 200, default
         */
        t.test('test deleteService delete operation', function (t) {
            Mockgen().requests({
                path: '/service/{id}',
                operation: 'delete'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/service/{id}']['delete']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
